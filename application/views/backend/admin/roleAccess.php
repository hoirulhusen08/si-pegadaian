...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <h5 class="text-muted"><a style="text-decoration: none;" href="<?= base_url('admin/role'); ?>"><i class="bi bi-arrow-left-circle-fill"></i> <small>Kembali</a> | Sebagai : <?= $role['role']; ?></small></h5>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
