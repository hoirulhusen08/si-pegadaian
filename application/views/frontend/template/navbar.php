        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <?php if ($this->session->userdata('email')) : ?>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle btn btn-success text-white btn-login" href="#" role="button" data-toggle="dropdown" aria-expanded="false">
                ...
                <?php else : ?>
                    <li class="nav-item">
                        <a class="nav-link btn btn-success text-white btn-login" data-toggle="modal" data-target="#loginModal" href="<?= base_url('auth'); ?>"><i class="bi bi-lock-fill"></i> Login</a>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
